Vue.component('schedule-desktop', {
    ...
    `
        <div class="schedule-desktop grid-1" >
            ...
            <div>
                <div class="subgrid-6" >
                    <div>
                        <p class="latinas-kids">LATINAS KIDS I</p>
                        <span>18h15</span>
                    </div>
                    <div>
                        <p class="kizomba">KIZOMBA I</p>
                        <span>20H00</span>
                    </div>
                    <div>
                        <p class="ballet">BALLET I</p>
                        <span>19h00</span>
                    </div>
                    <div>
                        <p class="latinas-kids">LATINAS KIDS I</p>
                    ...
                    <div>
                        <p class="contemporaneo">CONTEMPORANÊO</p>
                        <span>18h00</span>
                    </div>
                    <div>
                        <p class="pop-dance">POP DANCE I</p>
                        <span>11h00</span>
                    </div>
            ...
            <div>
                <div class="subgrid-6" >
                    <div>
                        <p class="latinas">LATINAS</p>
                        <span>19h00</span>
                    </div>
                    <div>
                        <p class="kizomba">KIZOMBA II</p>
                        <span>21h00</span>
                    </div>
                    <div>
                        <p class="bachata">BACHATA I</p>
                        <span>20h00</span>
                    </div>
                    <div>
                        <p class="latinas">LATINAS</p>
                    ...
                    <div>
                        <p class="ballet">BALLET II</p>
                        <span>19h00</span>
                    </div>
                    <div>
                        <p class="pop-dance">POP DANCE II</p>
                        <span>12h00</span>
                    </div>
                </div>
            </div>
            <div>
                <div class="subgrid-6" >
                    <div>
                        <p class="high-heels">HIGH HEELS</p>
                        <span>20h00</span>
                    </div>
                    <div>
